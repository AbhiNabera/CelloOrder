...
public class CustomerDatabaseHandler extends SQLiteOpenHelper {
    ...
    public boolean create(CustomerObject myObj) {
    ...
    public List<CustomerObject> read(String searchTerm) {

        List<CustomerObject> recordsList = new ArrayList<CustomerObject>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                CustomerObject myObject = new CustomerObject(objectName);
