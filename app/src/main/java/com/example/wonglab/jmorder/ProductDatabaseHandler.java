...
public class ProductDatabaseHandler extends SQLiteOpenHelper {
    ...
    public boolean create(ProductObject myObj) {
    ...
    public List<ProductObject> read(String searchTerm) {

        List<ProductObject> recordsList = new ArrayList<ProductObject>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                ProductObject myObject = new ProductObject(objectName);
